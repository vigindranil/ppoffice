...
//             CaseID: identity,
//             PPuserID: adv.advocateId, // Advocate ID from API response
//           });
//           console.log(`Email sent to advocate ${adv.advocateName}:`, advEmailRes);
//         }
//       } else {
...
//       console.log("Email sent to advocate:", issent);
...
//             CaseID: identity,
//             DistrictID: dept.districtId, // Get districtId from API response
//             PSID: dept.policeStationId,  // Get policeStationId from API response
//           });
//           console.log(`Email sent to department ${dept.districtName} (${dept.policeStationName}):`, deptEmailRes);
//         }
//       } else {
...
//       console.log("Email sent to the originating department:", originDeptEmailRes);
