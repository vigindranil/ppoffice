            ...
            <div className="mt-12 bg-white dark:bg-gray-800 rounded-xl shadow-md overflow-hidden">
              ...
              <div className="container px-4 mx-auto py-10">
                ...
                <DatePicker date={toDate ? formatDate(toDate) : null} setDate={setToDate} placeholder="To (Date Range)" /> */}
                  ...
                  <Button
                    className="mt-6 bg-blue-400 hover:bg-blue-600"
                    onClick={() =>
                          ...
                          <TableCell>
                            ...
                            >
                              ...
                              <DialogContent className="sm:max-w-auto">
                                ...
                                <DialogDescription>
                                  These informations are for case{" "}
                                  ...
                                  <CardContent>
                                    {selectedCase && (
                                      <div className="space-y-2">
                                        ...
                                        <p>
                                          <strong>
                                            Whether SP seen the mail:
                                          </strong>{" "}
                                          {selectedCase?.SP_Status
                                            ? "Yes"
                                            : "No"}
                                        </p>
                                        <p>
                                          <strong>
                                            Whether PS seen the mail:
                                          </strong>{" "}
                                          {selectedCase?.PS_Status
                                            ? "Yes"
                                            : "No"}
                                        </p>
                                      </div>
                          ...
                          <TableCell>
                            <Button
                              ...
                              onClick={() => {
                                ...
                                router.push(
                                  `/case-control-center/${enc_caseId}`
                                );
                              }}
                            >
                              <Edit /> Take Action
