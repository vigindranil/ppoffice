...
import { getPublicDocByCaseId } from "./api"
import moment, { isMoment } from "moment"
import DocumentTable from "@/components/public-document-table-component"
  ...
  useEffect(() => {
    const fetchDocuments = async () => {
      try {
        ...
        const response = await getPublicDocByCaseId(case_id); 
        ...
        <main className="flex-1 overflow-x-hidden overflow-y-auto bg-gray-100">
          ...
          <div className="container mx-auto px-6 py-8">
            <Tabs defaultValue="documents" className="w-full">
              <TabsList className="gap-6 justify-center mb-4 hidden">
