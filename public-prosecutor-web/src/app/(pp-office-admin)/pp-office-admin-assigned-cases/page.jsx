    ...
    <div className="relative min-h-screen w-full">
      ...
      <main className="relative flex-1 p-6 w-full min-h-screen">
        ...
        <Card className="w-full max-w-6xl mx-auto overflow-hidden bg-white/100 backdrop-blur-sm my-4">
          <CardHeader className="flex flex-row items-center justify-between mb-5  bg-gradient-to-r from-cyan-600 to-violet-600 px-6 py-3">
                          ...
                          <TableRow>
                            ...
                            <TableCell className="md:flex  hidden gap-2 mt-4">
                              <Button
                                ...
                                className="max-w-min items-center justify-center"
                              >
