...
const PPAllCaseList = () => {
  ...
  console.log("currentAllCaseList; ", currentAllCaseList);
                ...
                <Table>
                  <TableHeader>
                    <TableRow>
                      ...
                      <TableHead className="font-bold lg:table-cell">
                        Advocate
                      </TableHead>
                    </TableRow>
                  </TableHeader>
                      ...
                      currentAllCaseList?.map((head, index) => (
                        <React.Fragment key={index}>
                          <TableRow>
                            ...
                            <TableCell className="hidden lg:table-cell">
                              <Button onClick={() => handleAdvocateClick(head)}>
                                Advocate
                              </Button>
                            </TableCell>
                          </TableRow>
